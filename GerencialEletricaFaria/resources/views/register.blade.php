...
<body>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <input type="text" name="email" placeholder="user@example.com" id="email">
    
        <label for="password">Password</label>
        <input type="password" name="password" placeholder="Password" autocomplete="new-password" id="password">
    
        <label for="password_confirmation">Confirm Password</label>
        <input type="password" name="password_confirmation" placeholder="Confirm Password" autocomplete="new-password" id="password_confirmation">
